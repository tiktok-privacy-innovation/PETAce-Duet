...
macro(duet_combine_archives target dependency)
    if(MSVC)
...
macro(duet_fetch_thirdparty_content content_file)
    set(DUET_FETCHCONTENT_BASE_DIR_OLD ${FETCHCONTENT_BASE_DIR})
    set(FETCHCONTENT_BASE_DIR ${DUET_THIRDPARTY_DIR} CACHE STRING "" FORCE)
    include(${content_file})
    set(FETCHCONTENT_BASE_DIR ${DUET_FETCHCONTENT_BASE_DIR_OLD} CACHE STRING "" FORCE)
    unset(DUET_FETCHCONTENT_BASE_DIR_OLD)
endmacro()
